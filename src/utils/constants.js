...
// Coaches are now sourced from the database (GET /coaches) — see
// features/public-site/Coaches/Coaches.jsx — rather than hardcoded here.

export { baseUrl, playersData };
